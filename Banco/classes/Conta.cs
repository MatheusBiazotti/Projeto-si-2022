...
namespace Banco.classes
{
    public abstract class Conta
    {
        ...
        public  void Trasferir (decimal valor, Conta destino)
        {
            ...
            Console.WriteLine($"Alteração efetuada com sucesso da conta {Cliente.Nome} para {destino.Cliente.Nome} o valor R${valor} ");

            if(SucessoTrasacaoSaque && SucessoTransacaoDeposito)
            {
                Mensaguemtrans = "transacao Realizada com sucesso";
            }
            Mensaguemtrans = "Erro";
